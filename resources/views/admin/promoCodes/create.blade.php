    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.promo-codes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percent') ? 'is-invalid' : '' }}" type="number" name="percent" id="percent" value="{{ old('percent', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('active_until') ? 'is-invalid' : '' }}" type="text" name="active_until" id="active_until" value="{{ old('active_until') }}" required>
