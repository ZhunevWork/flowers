    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sizes.update", [$size->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('multiplier') ? 'is-invalid' : '' }}" type="number" name="multiplier" id="multiplier" value="{{ old('multiplier', $size->multiplier) }}" step="1" required>
