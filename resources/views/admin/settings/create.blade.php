    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vk') ? 'is-invalid' : '' }}" type="text" name="vk" id="vk" value="{{ old('vk', '') }}">
                @if($errors->has('vk'))
                    <div class="invalid-feedback">
                        {{ $errors->first('vk') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vyber') ? 'is-invalid' : '' }}" type="text" name="vyber" id="vyber" value="{{ old('vyber', '') }}">
                @if($errors->has('vyber'))
                    <div class="invalid-feedback">
                        {{ $errors->first('vyber') }}
                    </div>
