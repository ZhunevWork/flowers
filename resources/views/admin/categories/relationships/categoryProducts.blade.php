            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-categoryProducts">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.product.fields.durability') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.product.fields.event') }}
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.bouquet_size') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($products as $key => $product)
                        <tr data-entry-id="{{ $product->id }}">
                            ...
                            <td>
                                @foreach($product->events as $key => $item)
                                    <span class="badge badge-info">{{ $item->name }}</span>
                                @endforeach
                            </td>
                            <td>
                                {{ $product->bouquet_size ?? '' }}
                            </td>
                            <td>
                                {{ $product->height ?? '' }}
                            </td>
