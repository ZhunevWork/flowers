...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#user_bonus" role="tab" data-toggle="tab">
                {{ trans('cruds.bonu.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="user_bonus">
            @includeIf('admin.users.relationships.userBonus', ['bonus' => $user->userBonus])
        </div>
    </div>
</div>
