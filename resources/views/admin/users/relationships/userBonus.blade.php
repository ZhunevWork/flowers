...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userBonus">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    @foreach($bonus as $key => $bonu)
                        <tr data-entry-id="{{ $bonu->id }}">
                            ...
                            <td>
                                ...
                                @can('bonu_delete')
                                    <form action="{{ route('admin.bonus.destroy', $bonu->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-userBonus:not(.ajaxTable)').DataTable({ buttons: dtButtons })
