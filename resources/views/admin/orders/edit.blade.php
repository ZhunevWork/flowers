    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_total') ? 'is-invalid' : '' }}" type="number" name="sub_total" id="sub_total" value="{{ old('sub_total', $order->sub_total) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery') ? 'is-invalid' : '' }}" type="number" name="delivery" id="delivery" value="{{ old('delivery', $order->delivery) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('promocode') ? 'is-invalid' : '' }}" name="promocode_id" id="promocode_id">
                    @foreach($promocodes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('promocode_id') ? old('promocode_id') : $order->promocode->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('delivery_data') ? 'is-invalid' : '' }}" type="text" name="delivery_data" id="delivery_data" value="{{ old('delivery_data', $order->delivery_data) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('delivery_time') ? 'is-invalid' : '' }}" type="text" name="delivery_time" id="delivery_time" value="{{ old('delivery_time', $order->delivery_time) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('exact_time') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="exact_time" value="0">
                    <input class="form-check-input" type="checkbox" name="exact_time" id="exact_time" value="1" {{ $order->exact_time || old('exact_time', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="exact_time">{{ trans('cruds.order.fields.exact_time') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('anonim') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="anonim" value="0">
                    <input class="form-check-input" type="checkbox" name="anonim" id="anonim" value="1" {{ $order->anonim || old('anonim', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="anonim">{{ trans('cruds.order.fields.anonim') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recipient') ? 'is-invalid' : '' }}" type="text" name="recipient" id="recipient" value="{{ old('recipient', $order->recipient) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recipient_phone') ? 'is-invalid' : '' }}" type="text" name="recipient_phone" id="recipient_phone" value="{{ old('recipient_phone', $order->recipient_phone) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('check_address_recipient') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="check_address_recipient" value="0">
                    <input class="form-check-input" type="checkbox" name="check_address_recipient" id="check_address_recipient" value="1" {{ $order->check_address_recipient || old('check_address_recipient', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="check_address_recipient">{{ trans('cruds.order.fields.check_address_recipient') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('check_time_recipient') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="check_time_recipient" value="0">
                    <input class="form-check-input" type="checkbox" name="check_time_recipient" id="check_time_recipient" value="1" {{ $order->check_time_recipient || old('check_time_recipient', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="check_time_recipient">{{ trans('cruds.order.fields.check_time_recipient') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('photo_with_recipient') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="photo_with_recipient" value="0">
                    <input class="form-check-input" type="checkbox" name="photo_with_recipient" id="photo_with_recipient" value="1" {{ $order->photo_with_recipient || old('photo_with_recipient', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="photo_with_recipient">{{ trans('cruds.order.fields.photo_with_recipient') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postcard') ? 'is-invalid' : '' }}" type="text" name="postcard" id="postcard" value="{{ old('postcard', $order->postcard) }}">
