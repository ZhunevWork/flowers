    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_total') ? 'is-invalid' : '' }}" type="number" name="sub_total" id="sub_total" value="{{ old('sub_total', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery') ? 'is-invalid' : '' }}" type="number" name="delivery" id="delivery" value="{{ old('delivery', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('delivery_data') ? 'is-invalid' : '' }}" type="text" name="delivery_data" id="delivery_data" value="{{ old('delivery_data') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('delivery_time') ? 'is-invalid' : '' }}" type="text" name="delivery_time" id="delivery_time" value="{{ old('delivery_time') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('exact_time') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="exact_time" id="exact_time" value="1" {{ old('exact_time', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('anonim') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="anonim" id="anonim" value="1" {{ old('anonim', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recipient') ? 'is-invalid' : '' }}" type="text" name="recipient" id="recipient" value="{{ old('recipient', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recipient_phone') ? 'is-invalid' : '' }}" type="text" name="recipient_phone" id="recipient_phone" value="{{ old('recipient_phone', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('check_address_recipient') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="check_address_recipient" id="check_address_recipient" value="1" {{ old('check_address_recipient', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('check_time_recipient') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="check_time_recipient" id="check_time_recipient" value="1" {{ old('check_time_recipient', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('photo_with_recipient') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="photo_with_recipient" id="photo_with_recipient" value="1" {{ old('photo_with_recipient', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postcard') ? 'is-invalid' : '' }}" type="text" name="postcard" id="postcard" value="{{ old('postcard', '') }}">
