...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-events.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_type') ? 'is-invalid' : '' }}" type="text" name="event_type" id="event_type" value="{{ old('event_type', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('notification_today') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="notification_today" id="notification_today" value="1" {{ old('notification_today', 0) == 1 || old('notification_today') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('notification_before_three_day') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="notification_before_three_day" id="notification_before_three_day" value="1" {{ old('notification_before_three_day', 0) == 1 ? 'checked' : '' }}>
