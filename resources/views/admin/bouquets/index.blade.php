...
@can('bouquet_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.bouquets.create') }}">
                ...
                <tbody>
                    @foreach($bouquets as $key => $bouquet)
                        <tr data-entry-id="{{ $bouquet->id }}">
                            ...
                            <td>
                                @can('bouquet_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.bouquets.show', $bouquet->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('bouquet_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.bouquets.edit', $bouquet->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('bouquet_delete')
                                    <form action="{{ route('admin.bouquets.destroy', $bouquet->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('bouquet_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.bouquets.massDestroy') }}",
