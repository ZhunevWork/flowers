...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bouquets.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('durability') ? 'is-invalid' : '' }}" name="durability" id="durability">{{ old('durability') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('all_size') ? 'is-invalid' : '' }}" type="text" name="all_size" id="all_size" value="{{ old('all_size', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_price') ? 'is-invalid' : '' }}" type="number" name="discount_price" id="discount_price" value="{{ old('discount_price', '') }}" step="1">
