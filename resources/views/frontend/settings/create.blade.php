                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.settings.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vk" id="vk" value="{{ old('vk', '') }}">
                            @if($errors->has('vk'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('vk') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="whats_app" id="whats_app" value="{{ old('whats_app', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vyber" id="vyber" value="{{ old('vyber', '') }}">
                            @if($errors->has('vyber'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('vyber') }}
                                </div>
