                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.offers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cart" id="cart" value="{{ old('cart', '') }}" step="1" required>
                            @if($errors->has('cart'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="count" id="count" value="{{ old('count', '1') }}" step="1">
                            @if($errors->has('count'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('count') }}
                                </div>
