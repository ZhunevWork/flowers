    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.promo-codes.update", [$promoCode->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="code">{{ trans('cruds.promoCode.fields.code') }}</label>
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $promoCode->code) }}" required>
                            @if($errors->has('code'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="summ" id="summ" value="{{ old('summ', $promoCode->summ) }}" step="1">
                            @if($errors->has('summ'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('summ') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="percent" id="percent" value="{{ old('percent', $promoCode->percent) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $promoCode->is_active || old('is_active', 0) === 1 ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="active_until" id="active_until" value="{{ old('active_until', $promoCode->active_until) }}" required>
