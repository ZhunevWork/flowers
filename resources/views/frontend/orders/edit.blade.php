                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sub_total" id="sub_total" value="{{ old('sub_total', $order->sub_total) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="delivery" id="delivery" value="{{ old('delivery', $order->delivery) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="discount" id="discount" value="{{ old('discount', $order->discount) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="delivery_data" id="delivery_data" value="{{ old('delivery_data', $order->delivery_data) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="delivery_time" id="delivery_time" value="{{ old('delivery_time', $order->delivery_time) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="exact_time" id="exact_time" value="1" {{ $order->exact_time || old('exact_time', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="anonim" id="anonim" value="1" {{ $order->anonim || old('anonim', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="recipient" id="recipient" value="{{ old('recipient', $order->recipient) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="recipient_phone" id="recipient_phone" value="{{ old('recipient_phone', $order->recipient_phone) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="check_address_recipient" id="check_address_recipient" value="1" {{ $order->check_address_recipient || old('check_address_recipient', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="check_time_recipient" id="check_time_recipient" value="1" {{ $order->check_time_recipient || old('check_time_recipient', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="photo_with_recipient" id="photo_with_recipient" value="1" {{ $order->photo_with_recipient || old('photo_with_recipient', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="postcard" id="postcard" value="{{ old('postcard', $order->postcard) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="comment" id="comment" value="{{ old('comment', $order->comment) }}">
