    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bouquets.update", [$bouquet->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.bouquet.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $bouquet->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $bouquet->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="durability" id="durability">{{ old('durability', $bouquet->durability) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="height" id="height" value="{{ old('height', $bouquet->height) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="all_size" id="all_size" value="{{ old('all_size', $bouquet->all_size) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $bouquet->price) }}" step="1">
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="discount_price" id="discount_price" value="{{ old('discount_price', $bouquet->discount_price) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_stock" id="in_stock" value="1" {{ $bouquet->in_stock || old('in_stock', 0) === 1 ? 'checked' : '' }}>
