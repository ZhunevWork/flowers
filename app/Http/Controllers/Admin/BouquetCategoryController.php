...
class BouquetCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.bouquetCategories.index', compact('bouquetCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.bouquetCategories.create');
    }
    ...
    public function store(StoreBouquetCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.bouquet-categories.index');
    }
    ...
    public function edit(BouquetCategory $bouquetCategory)
    {
        ...
        return view('admin.bouquetCategories.edit', compact('bouquetCategory'));
    }
    ...
    public function show(BouquetCategory $bouquetCategory)
    {
        ...
        return view('admin.bouquetCategories.show', compact('bouquetCategory'));
    }
