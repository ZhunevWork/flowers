...
class DeliveryPeriodController extends Controller
{
    public function index()
    {
        ...
        return view('admin.deliveryPeriods.index', compact('deliveryPeriods'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.deliveryPeriods.create');
    }
    ...
    public function store(StoreDeliveryPeriodRequest $request)
    {
        ...
        return redirect()->route('admin.delivery-periods.index');
    }
    ...
    public function edit(DeliveryPeriod $deliveryPeriod)
    {
        ...
        return view('admin.deliveryPeriods.edit', compact('deliveryPeriod'));
    }
    ...
    public function show(DeliveryPeriod $deliveryPeriod)
    {
        ...
        return view('admin.deliveryPeriods.show', compact('deliveryPeriod'));
    }
