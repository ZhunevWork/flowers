...
class OrderController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.orders.create', compact('users', 'offers', 'promocodes', 'statuses', 'payments', 'addresses'));
    }
    ...
    public function edit(Order $order)
    {
        ...
        return view('admin.orders.edit', compact('users', 'offers', 'promocodes', 'statuses', 'payments', 'addresses', 'order'));
    }
