...
class QuickOrderController extends Controller
{
    public function index()
    {
        ...
        return view('admin.quickOrders.index', compact('quickOrders'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.quickOrders.create', compact('bouquets', 'sizes'));
    }
    ...
    public function store(StoreQuickOrderRequest $request)
    {
        ...
        return redirect()->route('admin.quick-orders.index');
    }
    ...
    public function edit(QuickOrder $quickOrder)
    {
        ...
        return view('admin.quickOrders.edit', compact('bouquets', 'sizes', 'quickOrder'));
    }
    ...
    public function show(QuickOrder $quickOrder)
    {
        ...
        return view('admin.quickOrders.show', compact('quickOrder'));
    }
