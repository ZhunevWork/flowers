...
class BouquetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.bouquets.index', compact('bouquets'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bouquets.create', compact('elements', 'sizes', 'bouquetcategories', 'colors', 'events'));
    }
    ...
    public function store(StoreBouquetRequest $request)
    {
        ...
        return redirect()->route('frontend.bouquets.index');
    }
    ...
    public function edit(Bouquet $bouquet)
    {
        ...
        return view('frontend.bouquets.edit', compact('elements', 'sizes', 'bouquetcategories', 'colors', 'events', 'bouquet'));
    }
    ...
    public function show(Bouquet $bouquet)
    {
        ...
        return view('frontend.bouquets.show', compact('bouquet'));
    }
