...
class ElementCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.elementCategories.index', compact('elementCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.elementCategories.create');
    }
    ...
    public function store(StoreElementCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.element-categories.index');
    }
    ...
    public function edit(ElementCategory $elementCategory)
    {
        ...
        return view('frontend.elementCategories.edit', compact('elementCategory'));
    }
    ...
    public function show(ElementCategory $elementCategory)
    {
        ...
        return view('frontend.elementCategories.show', compact('elementCategory'));
    }
