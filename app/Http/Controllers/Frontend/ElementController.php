...
class ElementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.elements.index', compact('elements'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.elements.create', compact('categories', 'colors'));
    }
    ...
    public function store(StoreElementRequest $request)
    {
        ...
        return redirect()->route('frontend.elements.index');
    }
    ...
    public function edit(Element $element)
    {
        ...
        return view('frontend.elements.edit', compact('categories', 'colors', 'element'));
    }
    ...
    public function show(Element $element)
    {
        ...
        return view('frontend.elements.show', compact('element'));
    }
