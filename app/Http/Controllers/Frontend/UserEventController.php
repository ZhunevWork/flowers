...
class UserEventController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userEvents.index', compact('userEvents'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userEvents.create', compact('users'));
    }
    ...
    public function store(StoreUserEventRequest $request)
    {
        ...
        return redirect()->route('frontend.user-events.index');
    }
    ...
    public function edit(UserEvent $userEvent)
    {
        ...
        return view('frontend.userEvents.edit', compact('users', 'userEvent'));
    }
    ...
    public function show(UserEvent $userEvent)
    {
        ...
        return view('frontend.userEvents.show', compact('userEvent'));
    }
