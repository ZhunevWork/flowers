...
class BonusController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.bonus.index', compact('bonus'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bonus.create', compact('users'));
    }
    ...
    public function store(StoreBonuRequest $request)
    {
        ...
        return redirect()->route('frontend.bonus.index');
    }
    ...
    public function edit(Bonu $bonu)
    {
        ...
        return view('frontend.bonus.edit', compact('users', 'bonu'));
    }
    ...
    public function show(Bonu $bonu)
    {
        ...
        return view('frontend.bonus.show', compact('bonu'));
    }
